...
4. Paste the `liferayinclusive-site-initializer.zip` into the `/deploy` folder inside your Liferay Portal 7.4 GA125 root directory.

5. Wait for the module to deploy.
